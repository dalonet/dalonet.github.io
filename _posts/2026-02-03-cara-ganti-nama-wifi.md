...
2. **Perangkat yang sudah terkoneksi TIDAK terputus** otomatis
3. **Password tetap sama** seperti sebelumnya

### Langkah untuk Pengguna:
1. **Cari nama WiFi baru** di list jaringan tersedia
2. **Koneksikan perangkat** menggunakan password yang sama
3. **Untuk perangkat yang sudah terkoneksi:**
...
4. **Hindari spasi berlebihan:** Gunakan tanda hubung (-) atau underscore (_)

### Contoh Nama WiFi Kreatif:
- `The-Force-Wifi` (Star Wars fans)
- `Wifi-Luar-Biasa`
- `Internet-Rumah-Kita`
- `Silent-Wifi-Zone`
- `Wifi-Super-Cepat`
...
**Solusi:**
1. Refresh halaman admin router
2. Restart router setelah perubahan
...
2. **Mengurangi serangan targeted** (attackers cenderung target nama default)
3. **Privacy meningkat** (tidak langsung tahu merk router dari nama)

### Tetap Waspada:
1. **Password harus tetap kuat** meski nama sudah diganti
2. **Aktifkan WPA2/WPA3** encryption
...
- **SSID2:** Untuk tamu (nama: `Wifi-Tamu`)
- **SSID3:** Untuk IoT devices (nama: `Smart-Home`)
...
**Q: Bisakah ganti nama WiFi via smartphone?**  
A: Ya, gunakan browser di smartphone yang terkoneksi ke WiFi tersebut.

**Q: Berapa karakter maksimal nama WiFi?**  
A: Umumnya 32 karakter, tapi beberapa router hanya mendukung 16-24 karakter.

**Q: Apakah perlu restart router setelah ganti nama?**  
A: Tidak harus, tapi direkomendasikan untuk perubahan berlaku optimal.

**Q: Bisakah menggunakan emoji di nama WiFi?**  
A: Tergangkat router. Sebagian mendukung, tapi tidak direkomendasikan untuk kompatibilitas.
